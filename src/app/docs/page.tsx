    ...
    <main className="min-h-screen bg-gray-950 text-white">
      <header className="border-b-4 border-purple-400 bg-gray-900 p-6">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-black">Social Graph Explorer Documentation</h1>
      ...
      <div className="max-w-4xl mx-auto p-8 space-y-8">
        <section className="bg-gray-900 border-4 border-purple-400 p-6">
          ...
          <p className="text-gray-300 mb-4">
            Explore and analyze social connections and community relationships on blockchain with real-time metrics and intuitive interface.
          </p>
...
└─────────────────────────────────────┘</pre>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <a href="https://github.com/Samdevrel/social-graph-explorer" target="_blank" className="block p-4 bg-gray-800 border-2 border-gray-600 hover:border-purple-400 transition">
